...
Main line: 42 topics.
Source-derived depth: 84 more — I13–I32, A13–A41, E10–E44. Off the main line, read on demand.
Optional milestones: three Databricks certifications — see the section below
```

**You are currently here:** B1–B9 + I1–I5 done (**14 of 42** main-line topics; 126 topics in total, counting the 84 source-derived ones). Next: ⬜ I6 — Caching and Persistence.
