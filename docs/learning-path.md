...
Main line: 42 topics.
Source-derived depth: 22 more — I13–I18, A13–A20, E10–E17. Off the main line, read on demand.
Optional milestones: three Databricks certifications — see the section below
```

**You are currently here:** B1–B9 + I1–I5 done (**14 of 42** main-line topics; 64 topics in total, counting the 22 source-derived ones). Next: ⬜ I6 — Caching and Persistence.
...
!!! info "About the source-derived topics (I13–I18, A13–A20, E10–E17)"
