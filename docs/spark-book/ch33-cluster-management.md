...
!!! note "📌 Topics deferred here from Chapter 2"
    Chapter 2 states executors stay alive for the entire application and that the cluster manager decides how many to launch. The following lifecycle details are covered in full here:
