...
flowchart LR
    ...
    S3 --> S3c2["KVStore indirection â€” AppStatusListener â†’ ElementTrackingStore â†’ AppStatusStore"]
    ...
    S3 --> S3c6["Metrics system â€” registration, config parsing, instance/source/sink resolution"]
    ...
    S3 --> S3c11["FsHistoryProvider â€” scan / replay / safemode / update loop"]
    ...
    S3 --> S3c15["UI security â€” ACLs, HTTP headers, reverse proxy"]
