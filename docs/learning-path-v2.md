...
**Estimated time:** 80–102 hrs · **51 topics**
...
**Done:** the Beginner level and the first five Intermediate topics under v1 numbering — v2 **B1–B4, B6–B8, B10–B11** and **I1, I8, I10, I16, I24**. That is **14 of 181**, with chapters written for each in [`docs/spark-book/`](spark-book/index.md).
...
- Topics are grouped into **strands** — 4 in Beginner, 13 in Intermediate, 13 in Advanced, 18 in Expert — so a level is a set of short runs rather than a list of forty.
...
Every v1 topic appears exactly once. The table below lists the seven topics that were new when v2 was written; the thirty added since by the feature-history audits (**I44**–**I51**, **A46**–**A58**, **E52**–**E60**) carry a **New topic** line in place of a v1 code and are not repeated here.
