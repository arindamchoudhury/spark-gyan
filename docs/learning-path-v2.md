...
> **Created:** 2026-08-09 — first full re-carve of the path since it was written, and rebuilt since: 185 topics in strands, every capability area of the [feature history](reference/spark-feature-history/index.md) audited row by row against Spark 4.2.0. The three most recent passes are below; the full dated record of every pass — including the ones that corrected a wrong claim rather than adding a topic — is the [changelog](learning-path-v2-changelog.md).
>
...
**Done:** the Beginner level and five Intermediate topics — **B1**–**B4**, **B6**–**B8**, **B10**–**B11**, and **I1**, **I8**, **I10**, **I16**, **I24**. That is **14 of 185**, with chapters written for each in [`docs/spark-book/`](spark-book/index.md).
